...
- вести расходы
- участвовать в подтверждении supplier request / supplier docs в своей зоне ответственности
...
- участвовать в подтверждении supplier request / supplier docs по управленческому правилу
