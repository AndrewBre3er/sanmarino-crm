...
describe(
  "prisma schema foundation (infra + users + CRM core + orders + supply inventory + payments/finance contract baseline)",
  () => {
    it("contains approved infra/system models, users models, and payments/finance contract baseline models", () => {
